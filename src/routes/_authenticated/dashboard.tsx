    ...
    <div className="mx-auto max-w-6xl space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Track the status of tickets you've submitted.</p>
        </div>
        <Link to="/new"><Button><PlusCircle className="mr-2 h-4 w-4" /> New complaint</Button></Link>
      </div>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="mt-1 text-sm text-muted-foreground">Submit your first ticket to see it here.</p>
              <Link to="/new" className="mt-4"><Button>Submit a complaint</Button></Link>
            </div>
          ) : (
              ...
              {data.map((c) => (
                ...
                >
                  <div className="min-w-0">
                    ...
                    <div className="mt-1 line-clamp-1 text-sm text-muted-foreground">{c.description}</div>
                    <div className="mt-1 text-xs text-muted-foreground">Submitted {formatDate(c.created_at)}</div>
                  </div>
